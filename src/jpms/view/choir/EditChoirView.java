...
public class EditChoirView extends AbstractView implements Initializable, IBasicView {
    ...
    private final String infoDialogKey = "EditChoirView.infoDialogKey";
    private final String warnDialogKey = "EditChoirView.warnDialogKey";
    ...
    private void handleRenameBtnAction(ActionEvent event){        
        ...
        if(isRenamed){
            ...
            //notify user
            viewModel.showDialog(SimpleDialog.class, DialogIcon.INFO, "Choir was renamed!", infoDialogKey);
        }
        else {
            //notify user
